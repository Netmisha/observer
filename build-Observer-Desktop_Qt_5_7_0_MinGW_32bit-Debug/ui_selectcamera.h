...
public:
    ...
    void setupUi(QMainWindow *SelectCamera)
    {
        ...
        camera_pathEdit = new QLineEdit(remote_settingBox);
        camera_pathEdit->setObjectName(QStringLiteral("camera_pathEdit"));
        camera_pathEdit->setMinimumSize(QSize(0, 25));

        horizontalLayout_3->addWidget(camera_pathEdit);
    ...
    void retranslateUi(QMainWindow *SelectCamera)
    {
        ...
        camera_pathEdit->setPlaceholderText(QApplication::translate("SelectCamera", "Path", 0));
        ...
        nextButton->setText(QApplication::translate("SelectCamera", "Tags", 0));
    } // retranslateUi
