...
public:
    ...
    void setupUi(QMainWindow *SettingsWindow)
    {
        ...
        sizePolicy1.setHeightForWidth(open_dialogButton->sizePolicy().hasHeightForWidth());
        open_dialogButton->setSizePolicy(sizePolicy1);
        open_dialogButton->setMinimumSize(QSize(50, 25));
        open_dialogButton->setMaximumSize(QSize(70, 25));
        ...
        sizePolicy1.setHeightForWidth(save_fileButton->sizePolicy().hasHeightForWidth());
        save_fileButton->setSizePolicy(sizePolicy1);
        save_fileButton->setMinimumSize(QSize(50, 25));
        save_fileButton->setMaximumSize(QSize(70, 25));

        horizontalLayout_7->addWidget(save_fileButton);
    ...
    void retranslateUi(QMainWindow *SettingsWindow)
    {
        ...
        open_dialogButton->setText(QApplication::translate("SettingsWindow", "Open", 0));
