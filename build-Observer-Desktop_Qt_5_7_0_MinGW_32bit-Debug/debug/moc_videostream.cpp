...
#include "../../Observer/videostream.h"
...
QT_MOC_LITERAL(4, 27, 7) // "OnTimer"
    ...
    "VideoStream\0SendImage\0\0Mat\0OnTimer"
};
...
void VideoStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (VideoStream::*_t)(Mat );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoStream::SendImage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject VideoStream::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoStream.data,
      qt_meta_data_VideoStream,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void VideoStream::SendImage(Mat _t1)
{
