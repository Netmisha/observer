...
<<<<<<< HEAD
void SelectCamera::ReceiveFromTags(SettingsFile *obj){
    this->show();
    SettingF = obj;
}
void SelectCamera::ReceiveFromMainWindow(SettingsFile *obj){
    this->show();
    SettingF = obj;
}
...
void SelectCamera::on_MainWindow_clicked()
{
    this->hide();
    emit PassToMain(SettingF);
}
void SelectCamera::ReceiveSettingSW(SettingsFile *obj){
    this->show();
    SettingF = obj;

}
void SelectCamera::on_Settings_clicked()
{
this->hide();
emit SendToSettings(SettingF);
}
